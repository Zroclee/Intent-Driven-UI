 ...
 * @param url 目标URL
 */
export async function launchBrowserAndVisit(url: string): Promise<{ browser: Browser; context: BrowserContext; page: Page }> {
  // 1. 启动浏览器
...
export async function addUser() {
  ...
  // 4. 访问指定URL
  await page.goto('http://localhost:5173/product/users', { waitUntil: 'domcontentloaded' });
